...
// 元数据键前缀定义
const static std::string kCommonKeyPrefix = "mooncake/";  // 通用前缀
const static std::string kRpcMetaPrefix = kCommonKeyPrefix + "rpc_meta/";  // RPC元数据前缀
